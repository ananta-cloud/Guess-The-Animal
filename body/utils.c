...
/**
 * @brief Mencetak header yang diformat ke konsol untuk judul menu.
 * @param title Teks yang akan ditampilkan sebagai judul header.
 */
void print_header(const char* title) {
    // Mencetak garis pemisah atas, judul, dan garis pemisah bawah
    print_separator();
    printf("        %s\n", title);
    print_separator();
    printf("\n"); // Memberi jarak setelah header
}

/**
 * @brief Mencetak garis pemisah standar ke konsol.
 */
